...
<div class="absolute inset-0 flex items-center justify-center z-50 p-4">
  <!-- Warning modal -->
  <div class="bg-black border-2 border-red-500 rounded-lg p-5 w-[28rem] shadow-lg shadow-red-500/50">
    ...
    <!-- Warning message -->
    <div class="bg-red-900 bg-opacity-20 border border-red-500 rounded p-3 mb-4">
      <div class="text-red-100 text-sm leading-relaxed font-mono">
        <div class="mb-2">
          <span class="text-red-400 font-bold">WARNING:</span> Proceeding beyond Level 3 will destabilize the quantum matrix.
        </div>
        
        <div class="mb-2 text-red-300">
          Consequence: An additional <span class="text-red-500 font-bold">2-DAMAGE BOMB ORB</span> will be injected into your glitch rift.
        </div>
        
        <div class="text-red-400 text-sm">
          This bomb will persist through Levels 4 through 7. Continue at your own risk.
        </div>
      </div>
    </div>
    ...
    <!-- Footer glitch text -->
    <div class="mt-3 text-center text-red-500 text-sm font-mono opacity-60 tracking-widest">
